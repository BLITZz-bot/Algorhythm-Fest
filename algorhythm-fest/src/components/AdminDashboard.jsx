                            ...
                            <div className="flex-1 overflow-auto rounded-3xl border border-white/10 bg-[#0f111a] flex flex-col items-center justify-center">
                                {!isControlsAuth ? (
                                    ...
                                    >
                                        ...
                                        <p className="text-gray-400 text-sm mb-6">Secondary authentication required to toggle event statuses.</p>
                                    ...
                                    <div className="w-full h-full p-8 overflow-auto">
                                        <h3 className="text-2xl font-bold text-white mb-6">Event Registerations Control</h3>
