...
export const eventsDay1 = [
  ...
  },
  {
    ...
    rules: ["1. Participants must be currently enrolled in their college.",
      ...
      "12. If you have registered for overlapping events, management is not responsible, no refund will be initiated.13. The participants from GCEM should contact the respective event coordinators before registering.",
  ...
  },
  {
    ...
    rules: ["1.	Each team must have 4-8 members.",
      ...
      "15. The participants from GCEM should contact the respective event coordinators before registering",
      ".",
      "'MUSIC RULES'",
