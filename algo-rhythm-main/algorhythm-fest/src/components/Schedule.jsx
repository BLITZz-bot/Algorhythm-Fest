...
export const eventsDay1 = [
  {
    ...
    rules: ["1. Participants must be currently enrolled students of their respective institutions.",
      "2. Each team must consist of 2 to 3 members. No individual participation is allowed.",
      ...
      "15. Please check the event schedule before registering multiple events. Participants are responsible for checking the event schedule. The MANAGEMENT is not responsible for clashes with other events, and no refund will be provided in case of overlap.The participants from GCEM should contact the respective event coordinator before registering",
  ...
  },
  {
    ...
    rules: ["*GAME RULES ARE SAME AS FIDE TOURNAMENTS*",
      ...
      "12. If you have registered for overlapping events, management will not be responsible and no refund will be initiated. The participants from GCEM should contact the respective event coordinators before registering.",
  ...
  },
  {
    ...
    rules: ["1. Participants must be currently enrolled in their college.",
      ...
      "11. If you have registered for overlapping events, management is not responsible, no refund will be initiated.13. The participants from GCEM should contact the respective event coordinators before registering.",
  ...
  },
  {
    ...
    rules: ["1. Participants must be currently enrolled in their college.",
      ...
      "9.  If you have registered for overlapping events, MANAGEMENT is not responsible, no refund will be initiated.10. The participants from GCEM should contact the respective event coordinators before registering.",
      ...
      ".",
      "JUDGING CRITERIA:",
      "1. Hook & First 3 Seconds Impact",
      "2. Ad Concept & Originality",
      "3. Brand/Product Integration",
      "4. Message Clarity & Communication",
      "5. Editing, Pacing & Video Optimization",
      "6. Marketing Effectiveness & Call-to-Action",
      "7. Presentation"
  ...
  },
  {
    ...
    rules: ["1. This event consists of two rounds that will be conducted on HackerRank.",
      ...
      "12. If you have registered for overlapping events, MANAGEMENT is not responsible and no refund will be initiated.The participants from GCEM should contact the respective event coordinators before registering.",
  ...
  },
  {
    ...
    rules: ["1.	Each team must have 4-8 members.",
      ...
      "14. The participants from GCEM should contact the respective event coordinators before registering",
      ".",
      "'MUSIC RULES'",
...
export const eventsDay2 = [
  {
    ...
    rules: ["  1. Participants must be currently enrolled in their respective colleges.",
      ...
      "10. If you have registered for overlapping events, MANAGEMENT is not responsible,any such situations no refund will be initiated.The participants from GCEM should contact the respective event coordinators before registering",
  ...
  },
  {
    ...
    rules: ["1.	Participants must be currently enrolled students of their respective institutions.",
      ...
      "15. Participants are responsible for checking the event schedule. The Management is not responsible for clashes with other events, and no refund will be provided in case of overlap. The participants from GCEM should contact the respective event coordinators before registering",
      "16. Report to the coordinator 30 minutes before the event starts.",
      "17.Participants of other events will get a complimentary audience pass for VINTARA (Fashion Show).",
    ],
  ...
  },
  {
    ...
    rules: ["1. Participants must carry valid college ID card.",
      ...
      "10. Please check the schedule for overlapping events before registering multiple events.",
      "11. Participants are responsible for checking the event schedule. The Management is not responsible for clashes with other events, and no refund will be provided in case of overlap. The participants from GCEM should contact the respective event coordinators before registering",
      "12.Participants of other events will get a complimentary audience pass for VINTARA (Fashion Show).",
    ],
...

  {
    ...
    rules: ["*Duration: 6-8 minutes per team for their performance*",
      ...
      "• If registered for overlapping events, MANAGEMENT is not responsible and no refund will be initiated.The participants from GCEM should contact the respective event coordinators before registering",
  ...
  },
  {
    ...
    rules: ["1. Participants must be currently enrolled in their college.",
      ...
      "-Brand Understanding & Marketing Strategy",
      ...
      "16. If you have registered for overlapping events, MANAGEMENT is not responsible, no refund will be initiated.The participants from GCEM should contact the respective event coordinators before registering",
  ...
  },
  {
    ...
    rules: ["1. Participants may use only text-to-image prompting; image-to-image, reference image, or control features are strictly prohibited.",
      ...
      "17. If you have registered for overlapping events, management is not responsible, no refund will be initiated.The participants from GCEM should contact the respective event coordinators before registering",
