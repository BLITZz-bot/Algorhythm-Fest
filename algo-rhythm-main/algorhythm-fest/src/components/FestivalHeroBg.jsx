  ...
  return (
    <div className="absolute inset-0 -z-10 overflow-hidden">
      ...
      <motion.div
        ...
        className="absolute w-96 h-96 bg-[radial-gradient(circle,rgba(168,85,247,0.15)_0%,transparent_70%)] rounded-full top-[10%] left-[10%] will-change-transform"
      />

      <motion.div
        animate={{ y: [0, 40, 0] }}
        transition={{ duration: 16, repeat: Infinity }}
        className="absolute w-96 h-96 bg-[radial-gradient(circle,rgba(236,72,153,0.15)_0%,transparent_70%)] rounded-full bottom-[10%] right-[10%] will-change-transform"
      />
