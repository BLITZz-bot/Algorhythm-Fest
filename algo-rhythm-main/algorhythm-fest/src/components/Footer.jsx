      ...
      <div className="max-w-6xl mx-auto px-6 py-10 grid md:grid-cols-3 gap-8 text-center md:text-left">
        ...
        <div className="flex flex-col items-center">
          ...
          <div className="flex gap-4">
            {/* Instagram */}
            <a href="https://www.instagram.com/gcem.students/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-[#E1306C] hover:text-white hover:border-transparent hover:bg-gradient-to-tr hover:from-[#F56040] hover:via-[#E1306C] hover:to-[#833AB4] transition-all group shadow-lg">
            ...
            {/* LinkedIn */}
            <a href="http://www.linkedin.com/in/gcem" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-[#0A66C2] hover:text-white hover:border-[#0A66C2] hover:bg-[#0A66C2] transition-all group shadow-lg">
            ...
            {/* Facebook */}
            <a href="https://www.facebook.com/gcem.students" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-[#1877F2] hover:text-white hover:border-transparent hover:bg-[#1877F2] transition-all group shadow-lg">
