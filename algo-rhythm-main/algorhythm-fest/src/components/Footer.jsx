      ...
      <div className="max-w-6xl mx-auto px-6 py-10 grid md:grid-cols-3 gap-8 text-center md:text-left">
        ...
        <div className="flex flex-col items-center">
          ...
          <div className="flex gap-4">
            ...
            {/* Twitter (X) */}
            <a href="https://x.com/gcem_cse" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-white hover:text-black hover:border-white hover:bg-white transition-all group shadow-lg">
